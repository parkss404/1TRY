...
["청주직지감자탕뼈찜","강남면옥","덮밥","쌀국수","달꽃다방","바니시버거","짜장면","똥짐참맛있는집","오징어회포차","보쌈당한족발","닭강정","엄마닭발","일미닭갈비파전 본점","찜닭","신전떡볶이","피자파는집 청주흥덕구점","둥지마을왕족발","부대찌개","쭈꾸미","파파돈","대구전봇대막창","삼촌스시","탕화쿵푸","짬뽕","매운치킨","교동칼국수"],
["병천토종순대 직영점","서민냉면얼큰칼국수","덮밥","쌀국수","파스타","햄버거","짜장면","에꿍이치킨","팔팔어시장","보쌈","닭강정","서울닭발","닭볶음탕","찜닭","떡보라","피자","족발","부대찌개","쭈꾸미","김우동","막창선생","초밥한조각 사직점","마라탕","면세상","가마꿉","일심칼국수"]
]
